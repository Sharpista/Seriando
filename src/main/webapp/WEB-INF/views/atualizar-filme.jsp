...
<div class="container">
	...
	<a onclick="location.href='/inicio';"></a>
		<h2>Edição</h2>
		<form action="/atualizarFilme/${produto.idProduto}" class="form" method="post">
			...
			<label for="senha">Duração</label>
			<input type="text" name="duracao" value="${produto.duracao}"placeholder="Duração">
